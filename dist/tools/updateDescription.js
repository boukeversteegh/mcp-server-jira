    ...
    inputSchema: {
        ...
        properties: {
            ...
            descriptionFormat: {
                ...
                description: "Format of the description text: 'plain' (default) for simple text, 'wiki' for Jira wiki markup (h2., {code}, *bold*, etc.), 'markdown' for Markdown (## headings, **bold**, ```code```), 'adf' for raw Atlassian Document Format JSON"
            }
        },
